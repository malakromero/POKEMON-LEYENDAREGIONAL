...
static void SpriteCB_TitleBoat(struct Sprite *sprite);

// const rom data
static const u16 sUnusedUnknownPal[] = INCBIN_U16("graphics/title_screen/unused.gbapal");

static const u16 sTitleScreenSeaGfx[] = INCBIN_U16("graphics/seagallop/water.4bpp");
static const u16 sTitleScreenSeaTilemap[] = INCBIN_U16("graphics/seagallop/wb_tilemap.bin");
static const u16 sTitleScreenSeaPal[] = INCBIN_U16("graphics/seagallop/water.gbapal");
...
static const u16 sTitleScreenBoatSpriteTiles[] = INCBIN_U16("graphics/seagallop/ferry_sprite.4bpp");
static const u16 sTitleScreenBoatSpritePal[] = INCBIN_U16("graphics/seagallop/ferry_and_wake.gbapal");
...
static const struct OamData sTitleBoatOamData =
{
    .size = SPRITE_SIZE(64x64),
};

static const union AnimCmd sTitleBoatAnim[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_END,
};

static const union AnimCmd *const sTitleBoatAnimTable[] =
{
    sTitleBoatAnim,
};

static const struct SpriteTemplate sTitleBoatSpriteTemplate =
{
    .tileTag = TAG_BOAT,
    .paletteTag = TAG_BOAT,
    .oam = &sTitleBoatOamData,
    .anims = sTitleBoatAnimTable,
    .callback = SpriteCB_TitleBoat,
};

static const struct SpriteSheet sSpriteSheet_TitleBoat[] =
{
    {
        .data = sTitleScreenBoatSpriteTiles,
        .size = sizeof(sTitleScreenBoatSpriteTiles),
        .tag = TAG_BOAT,
    },
    {},
};

static const struct SpritePalette sSpritePalette_TitleBoat[] =
{
    {
        .data = sTitleScreenBoatSpritePal,
        .tag = TAG_BOAT,
    },
    {},
};
...
void CB2_InitTitleScreen(void)
{
    ...
    case 1:
        ...
        // bg3
        DmaCopy16(3, sTitleScreenSeaGfx, (void *)(BG_CHAR_ADDR(2)), sizeof(sTitleScreenSeaGfx));
        DmaCopy16(3, sTitleScreenSeaTilemap, (void *)(BG_SCREEN_ADDR(26)), sizeof(sTitleScreenSeaTilemap));
        LoadPalette(sTitleScreenSeaPal, BG_PLTT_ID(4), sizeof(sTitleScreenSeaPal));
        // bg1
        ...
        LoadSpriteSheets(sSpriteSheet_TitleBoat);
        LoadPalette(gTitleScreenEmeraldVersionPal, OBJ_PLTT_ID(0), PLTT_SIZE_4BPP);
        LoadSpritePalette(&sSpritePalette_PressStart[0]);
        LoadSpritePalettes(sSpritePalette_TitleBoat);
        gMain.state = 2;
        break;
    case 2:
    {
...
static void Task_TitleScreenPhase2(u8 taskId)
{
    ...
    else
    {
        ...
        CreateSprite(&sTitleBoatSpriteTemplate, 48, 122, 1);
...
// Show sea/horizon composition and process main title screen input
